...
starting_prompt = """
                           Given a list of ingredients, generate a list of recipes that  
                           includes their name, description, a list of ingredients, and the directions on how to  
                           ...
                           output on the language given in the output_language params   Example:    
                            parameters = %s 
                            OUTPUT: {"recipes": [{"name":"REESE'S " 
                           ...
                           parameters = %s
                            ...
                            OUTPUT:  
                           """%(RecipeGenerationPrompValue.example_params, RecipeGenerationPrompValue.params)
